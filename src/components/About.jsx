...
import { 
	...
	SiFirebase, SiTypescript, SiGit } from 'react-icons/si'
			...
			<div className="banner">
				...
				<motion.div className="info"
					...
					<div className="skills">
                        ...
                        <a href="https://www.typescriptlang.org" target="_blank" rel="noreferrer" className="skill" title="TypeScript" >
                            <SiTypescript />
                        </a>
                        ...
                        <a href="https://git-scm.com" target="_blank" rel="noreferrer" className="skill" title="Git">
                            <SiGit />
                        </a>
					</div>
				</motion.div>
